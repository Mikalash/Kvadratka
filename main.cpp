...
/**
Задаёт значения, которые будут возвращать функции
ROOT_1 - 1 корень
ROOT_2 - 2 корня
ROOT_INF - бесконечность корней
ROOT_NO - нет корней
*/
enum ROOTS {
    ROOT_1 = 1,
...
/**
Проверяет значения a,b,c на то, принадлежат ли они NAN
*/
int input_check (double a, double b, double c);

/**
Сравнивает значение value c 0
*/
int cmp_with_0 (double value);

/**
Решает линейную функицю вида bx+c=0; x1-номер ячейки, в которую будет сослан ответ.
*/
int linear_equation (double b, double c, double* x1);

/**
Решает линейную функицю вида ax^2+bx+c=0; x1,x2-номерf ячеек, в которые будет сослан ответ.
*/
int quadratic_equation (double a, double b, double c, double* x1, double* x2);

/**
Считает дискриминант квадратного уравнения вида ax^2+bx+c=0
*/
